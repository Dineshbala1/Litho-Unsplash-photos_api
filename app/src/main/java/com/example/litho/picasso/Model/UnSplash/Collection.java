...
public class Collection implements Parcelable
{
    ...
    @Expose
    private List<PreviewPhoto> previewPhoto;
    @SerializedName("tags")
    @Expose
    ...
    public final static Creator<Collection> CREATOR = new Creator<Collection>() {
        ...
        public Collection createFromParcel(Parcel in) {
            ...
            instance.previewPhoto = ((List<PreviewPhoto>)in.readValue((Links.class.getClassLoader())));
            return instance;
        }
    ...
    public List<PreviewPhoto> getPreviewPhoto() {
        return previewPhoto;
    }

    public void setPreviewPhoto(List<PreviewPhoto> previewPhoto) {
